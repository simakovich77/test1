    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-6 featured-news">
                ...
                <?php foreach ($NewsData as $index => $News) : ?>
                <div class="row">
                    <div class="col-xs-4"><a href="page-blog-post-right-sidebar.html"><img src=<?php echo $News->img; ?> alt="Post Title"></a></div>
                    <div class="col-xs-8">
                        <div class="caption"><a href="page-blog-post-right-sidebar.html"><?php echo $News->title; ?></a></div>
